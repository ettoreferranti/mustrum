...
| E11-2 | GUI: tags editing (add/remove on sources and ideas), contact links (link a contact to a source/idea with a reason, `mustrum contact link` counterpart), audit upload (`POST /api/audit`, `mustrum audit` counterpart) | C | done |
