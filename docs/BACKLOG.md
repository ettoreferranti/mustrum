...
| ID | Story | Prio | Status |
|---|---|---|---|
| E10-1 | AnthropicProvider implementing LLMProvider (config-switchable via `llm_provider`/`anthropic_model`/`anthropic_max_tokens`, no core changes, ADR-21) ([PR #17](https://github.com/ettoreferranti/mustrum/pull/17)) | M | done |
