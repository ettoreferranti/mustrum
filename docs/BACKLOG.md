...
| E10-2 | Provider benchmarking harness: same tasks via fake/Ollama/Anthropic, compare grounding-verification pass rates; unavailable providers reported as such, never scored 0% (ADR-22, `mustrum benchmark`) | S | done |
